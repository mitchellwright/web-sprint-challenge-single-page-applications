...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    ...
    The useRouteMatch hook is used to gain access to match data without rendering a new route.

1. How would you explain form validation to someone who has never programmed before?

    Validation is when you want to make sure that what a user enters into a field is the format that you want it to be in. When you want a phone number, you need to make sure that it's actually a phone number.

1. In 1-2 sentences, define end to end testing.

    E2E testing is when you automate a test to use your application in the same way a user would to ensure that there are no bugs or errors.
